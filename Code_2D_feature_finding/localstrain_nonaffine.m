function [out,D2] = localstrain_NonAffine_tom(a0,a1,p_size)
...
% p_size is the average distance between particles in pixels.
% 
...
NNacceptance = p_size*1.5; % corresponds to the first minimum in the g(r)



min = 1;
epsilontensor = zeros(N,9);
D2=zeros(N,1);
for ii = 1:N
    p0 = a0(ii,1:3);     % off-atoms --------------------------
    p1 = a1(ii,1:3);
